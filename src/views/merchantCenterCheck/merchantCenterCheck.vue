    ...
    <div class="pad_5">
        ...
        <el-dialog
            ...
            <el-form
                ...
                <el-form-item label="招商名称" prop="merchant_name">
                    <el-input v-model="add_form.merchant_name" placeholder="招商中心名称" class="wid_180"></el-input>
                </el-form-item>
        ...
        <el-dialog
            ...
            <el-form :inline="true" :model="detail_form"   class="demo-form-inline " label-width="68px" disabled>
                ...
                <el-form-item label="开户行" prop="account_bank" label-width="68px">
                    <el-input v-model="detail_form.account_bank" placeholder="" class="wid_180"></el-input>
                </el-form-item>
                <el-form-item label="账号" prop="account_no" label-width="68px">
        ...
        <el-dialog
            ...
            <el-form :inline="true" :model="detail_check_form"   class="demo-form-inline " disabled>
                ...
                <el-form-item label="开户行" prop="account_bank" label-width="68px">
                    <el-input v-model="detail_check_form.account_bank" placeholder="" class="wid_180"></el-input>
                </el-form-item>
                <el-form-item label="账号" prop="account_no" label-width="68px">
    ...
    methods:{
        ...
        handle_check(){
            if(this.m_valid_addForm('detail_check_form')){
                ...
                this.detail_check_loading = true
                this.$http.post(`${ commonUrl.baseUrl}/merchantCenter/checkMerchantCenter`, param).then(res=>{
                    if(res.data.code == '0000'){
                        console.log(res)
                        this.detail_check_loading = false
