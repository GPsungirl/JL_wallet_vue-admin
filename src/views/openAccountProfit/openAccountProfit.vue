  ...
  <div class="pad_5">
    ...
    <div class="query_fields pad_b_no handle_timerange">
      ...
      >
        ...
        <!-- 所属机构 -->
        <el-form-item label="所属机构" prop="agent_name" v-if="roleId != 2">
    ...
    <div>
      ...
      <el-table :data="tableData" v-loading="tableLoading" border stripe style="width: 100%">
        <!-- 收款用户 -->
        <el-table-column prop="userName" label="开户用户" width="80"></el-table-column>
        <!-- 所属机构 -->
        <el-table-column v-if="roleId != 2" prop="agent_name" label="所属机构" width></el-table-column>
        <!-- 交易订单号 -->
        ...
        <el-table-column prop='checkAmount' label="交易金额(元)" width>
          <!-- <template slot-scope="scope">
        ...
        <!-- 提成金额 -->
        <el-table-column prop="activeFee" label="提成金额(元)" width></el-table-column>
      </el-table>
      <!-- 分页 -->
...
export default {
  ...
  methods: {
    ...
    getTabelDataList(pageNum) {
      ...
      this.$http
        .post(
          `${commonUrl.baseUrl}/accountProfitInfo/openAccountProfitInfoList`,
          param
        )
        .then(res => {
    ...
    exportData() {
      ...
      axios({
        method: "post",
        url: `${commonUrl.baseUrl}/accountProfitInfo/exportOpenAccountProfit`,
        // headers里面设置token
        headers: {
          Authorization: token
        },
